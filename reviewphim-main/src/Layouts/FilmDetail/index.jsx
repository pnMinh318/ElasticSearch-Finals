    ...
    return (
        <div className="film-detail">
            <div className="content">
                ...
                <img
                    className="film-img" src={filmList._source.image}
                    alt="film-img" />
                ...
                <div className="film-review">
                    ...
                    <img src={filmList._source.content[0].sectionContent} className="film-img" />
                    <p className="film-text">
                        {filmList._source.content[1].sectionContent}
                    </p>
                    <p className="film-text">
                        {filmList._source.content[2].sectionContent}
                    </p>
